...
func init() {
	...
	md_Denom = File_monetachain_tokenfactory_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_monetachain_tokenfactory_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "monetachain.tokenfactory.Denom.denom":
		return x.Denom != ""
	case "monetachain.tokenfactory.Denom.description":
		return x.Description != ""
	case "monetachain.tokenfactory.Denom.ticker":
		return x.Ticker != ""
	case "monetachain.tokenfactory.Denom.precision":
		return x.Precision != int32(0)
	case "monetachain.tokenfactory.Denom.url":
		return x.Url != ""
	case "monetachain.tokenfactory.Denom.maxSupply":
		return x.MaxSupply != ""
	case "monetachain.tokenfactory.Denom.supply":
		return x.Supply != ""
	case "monetachain.tokenfactory.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "monetachain.tokenfactory.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: monetachain.tokenfactory.Denom"))
		}
		panic(fmt.Errorf("message monetachain.tokenfactory.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message monetachain.tokenfactory.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "monetachain.tokenfactory.Denom.denom":
		panic(fmt.Errorf("field denom of message monetachain.tokenfactory.Denom is not mutable"))
	case "monetachain.tokenfactory.Denom.description":
		panic(fmt.Errorf("field description of message monetachain.tokenfactory.Denom is not mutable"))
	case "monetachain.tokenfactory.Denom.ticker":
		panic(fmt.Errorf("field ticker of message monetachain.tokenfactory.Denom is not mutable"))
	case "monetachain.tokenfactory.Denom.precision":
		panic(fmt.Errorf("field precision of message monetachain.tokenfactory.Denom is not mutable"))
	case "monetachain.tokenfactory.Denom.url":
		panic(fmt.Errorf("field url of message monetachain.tokenfactory.Denom is not mutable"))
	case "monetachain.tokenfactory.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message monetachain.tokenfactory.Denom is not mutable"))
	case "monetachain.tokenfactory.Denom.supply":
		panic(fmt.Errorf("field supply of message monetachain.tokenfactory.Denom is not mutable"))
	case "monetachain.tokenfactory.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message monetachain.tokenfactory.Denom is not mutable"))
	case "monetachain.tokenfactory.Denom.owner":
		panic(fmt.Errorf("field owner of message monetachain.tokenfactory.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: monetachain.tokenfactory.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in monetachain.tokenfactory.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_monetachain_tokenfactory_denom_proto_rawDescGZIP(), []int{0}
}
...
var File_monetachain_tokenfactory_denom_proto protoreflect.FileDescriptor

var file_monetachain_tokenfactory_denom_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe7, 0x02, 0x0a, 0x05, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x12, 0x14,
	...
	0x75, 0x72, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x12, 0x4e,
	...
	0xb0, 0x2a, 0x01, 0x52, 0x09, 0x6d, 0x61, 0x78, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x12, 0x48,
	0x0a, 0x06, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x42, 0x30,
	...
	0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x42, 0xd6,
	...
	,
	...
	0x6e, 0x65, 0x74, 0x61, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x3a, 0x3a, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_monetachain_tokenfactory_denom_proto_rawDescOnce sync.Once
	file_monetachain_tokenfactory_denom_proto_rawDescData = file_monetachain_tokenfactory_denom_proto_rawDesc
)

func file_monetachain_tokenfactory_denom_proto_rawDescGZIP() []byte {
	file_monetachain_tokenfactory_denom_proto_rawDescOnce.Do(func() {
		file_monetachain_tokenfactory_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_monetachain_tokenfactory_denom_proto_rawDescData)
	})
	return file_monetachain_tokenfactory_denom_proto_rawDescData
}

var file_monetachain_tokenfactory_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_monetachain_tokenfactory_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: monetachain.tokenfactory.Denom
}
var file_monetachain_tokenfactory_denom_proto_depIdxs = []int32{
...
func init() { file_monetachain_tokenfactory_denom_proto_init() }
func file_monetachain_tokenfactory_denom_proto_init() {
	if File_monetachain_tokenfactory_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_monetachain_tokenfactory_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_monetachain_tokenfactory_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_monetachain_tokenfactory_denom_proto_goTypes,
		DependencyIndexes: file_monetachain_tokenfactory_denom_proto_depIdxs,
		MessageInfos:      file_monetachain_tokenfactory_denom_proto_msgTypes,
	}.Build()
	File_monetachain_tokenfactory_denom_proto = out.File
	file_monetachain_tokenfactory_denom_proto_rawDesc = nil
	file_monetachain_tokenfactory_denom_proto_goTypes = nil
	file_monetachain_tokenfactory_denom_proto_depIdxs = nil
}
